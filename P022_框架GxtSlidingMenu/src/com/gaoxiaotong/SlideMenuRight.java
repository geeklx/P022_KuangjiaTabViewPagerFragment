...
public class SlideMenuRight extends ViewGroup {
	...
	public SlideMenuRight(Context context) {
		this(context, null, 0);
	}

	public SlideMenuRight(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public SlideMenuRight(Context context, AttributeSet attrs, int defStyle) {
